...
import miImagen from '../imagenes/bienvenida.jpg'; // importamos nuestra imagen de la carpeta imagenes

//CREAMOS LA FUNCION BIENVENIDA QUE RETORNA LA SECCION DE BIENVENIDA Y UBICACIONES DE SOFA Y CAFE
function Bienvenida(){
    return (
                 ...
                 <div className="row align-items-center">
                   <div className={`col-md-7 mb-4 mb-md-0  `}>
                     <img 
                       ...
                       className={styl.imagen_bienvenida}
                        />
                   </div>
                   <div className="col-md-5">
                     <h1 className="mb-4 text-warning">SOFA Y CAFE</h1>
                      ...
                      {/* se comporta como un botón el link  */} 
